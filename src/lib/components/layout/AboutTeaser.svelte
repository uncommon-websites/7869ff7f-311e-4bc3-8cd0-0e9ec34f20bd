...
<script lang="ts">
    ...
    name: "Founder, Apple",
    role: "Founder",
    image: "/generated/image-a-thoughtful-founder-in-a-modern-workspa.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`“We began with a belief: that technology should enrich daily life through simplicity, performance, and design. When it works beautifully, it disappears—leaving only possibility.”`}
    />
